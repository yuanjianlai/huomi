function HomeBannerController($scope, $http, $window) {
  ...
  this.showTrainerSignUpBox = function() {
    var firstNameInput = angular.element( document.querySelector( '.sign_up_box_firstname' ));
    var lastNameInput  = angular.element( document.querySelector( '.sign_up_box_lastname'  ));
    var emailInput = angular.element( document.querySelector( '.sign_up_box_email' ));
    var cityInput = angular.element (document.querySelector( '.sign_up_box_city' ));
    var trainerSignUpLink = angular.element( document.querySelector( '.trainer_sign_up_link'));
    var traineeSignUpLink = angular.element( document.querySelector( '.trainee_sign_up_link'));
    var traineeSignUpText = angular.element( document.querySelector( '.sign_up_trainee_text'));
    var trainerSignUpText = angular.element( document.querySelector( '.sign_up_trainer_text'));
    var trainerSignUpBtn = angular.element( document.querySelector( '.trainer_sign_up_btn'));
    var traineeSignUpBtn = angular.element( document.querySelector( '.trainee_sign_up_btn'));
